    ...
    return (
        <div className="border p-3 shadow bg-white">
            ...
            <div className="p-5">
                ...
                {/* Si botonAgregar es true, mostramos el boton */}
                {botonAgregar && (
                    <button type='button'
                        className='bg-indigo-600 hover:bg-indigo-800 text-white w-full mt-5 p-3
                uppercase font-bold'
                        /* Abriendo el modal, y tambien añadimos el producto a nuestro provider */
                        onClick={() => {
                            handleClickModal();
                ...
                {/* Si botondisponible es true, mostramos el boton */}
                {botonDisponible && (
                    <button type='button'
                        className='bg-indigo-600 hover:bg-indigo-800 text-white w-full mt-5 p-3
            uppercase font-bold'
