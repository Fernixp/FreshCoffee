...
export default function ModalProducto() {
    ...
    /* Para editar la cantidad */
    const [edicion, setEdicion] = useState(false);

    /* Las dependencias [] son opcionales, useEffect lo utilizamos para verificar 
    si el producto agregado ya se encuentraen el pedido */
    useEffect(() => {
            ...
            <div className='md:w-2/3'>
                ...
                font-bold uppercase rounded'
                    onClick={() => {
                        ...
                        /* Cuando agrega el producto al carrito, el modal se cierra autimaticamente, llamamos la funcion */
                        handleClickModal()
                    }}>
                    {/*  */}
